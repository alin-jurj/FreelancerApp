...
const PendingOffers = () => {
    ...
    let acceptedUserOffers = joboffers.filter(function (e) {
    ...
    return (
        <BodyStyle>
            ...
            <Grid container spacing={3} style={{paddingLeft: '40px', paddingRight: '40px'}}>
                <Grid item xs={12}>
                    <Typography variant="h5" style={{fontFamily: 'Nunito'}}>My Accepted Offers</Typography>
                </Grid>

                {
                    acceptedUserOffers.map( (offer) => {
                        return (
                            <Grid item xs={12}>
